...
describe('Regions Endpoints', function() {
  ...
  before('drop the dogs table', () => db.raw('DROP TABLE if exists dogs'))

  before('drop the regions table', () => db.raw('DROP TABLE if exists regions'))

  before('create regions table', () => db.raw(`CREATE TABLE regions (
    id INTEGER PRIMARY KEY GENERATED BY DEFAULT AS IDENTITY,
    name TEXT NOT NULL, 
    description TEXT NOT NULL
  )`))

  before('create dogs table', () => db.raw(`CREATE TABLE dogs (
    id INTEGER PRIMARY KEY GENERATED BY DEFAULT AS IDENTITY,
    name TEXT NOT NULL, 
    breed TEXT NOT NULL,
    size TEXT NOT NULL,
  ...
  describe(`GET /api/regions`, () => {
    context('Given there are regions in the database', () => {
      ...
      it('responds with 200 and all of the regions', () => {
  ...
  describe(`GET /api/regions/:region_id`, () => {
    context('Given there are regions in the database', () => {
      const testRegion = {
        id: 4,
        name: 'Region Four',
        description: 'All about region four.'
      }

      before('insert regions', () => {
        return db
          .into('regions')
          .insert(testRegion)
      })

      it('responds with 200 and appropriate region', () => {
        const regionId = 4
        const expectedRegion = testRegion
        return supertest(app)
